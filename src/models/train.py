...
def split_into_training_and_testing_sets(data_array):
    ...
    '''
    The function randomly splits the argument array into training and testing arrays in the ratio 3:1, and returns the resulting arrays in a tuple.
    '''
    num_training = int(float(3/4) * data_array.shape[0])
